    ...
    <div style={{ backgroundColor: '#F8F9FA', minHeight: '100vh', fontFamily: "'Inter', sans-serif", paddingBottom: '100px' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '24px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          <button onClick={() => navigate(-1)} style={{ background: 'none', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', padding: 0 }}><ChevronLeft size={28} color="#111827" /></button>
      ...
      <div style={{ padding: '0 24px', maxWidth: '1200px', margin: '0 auto' }}>
        ...
        {projetos.map((proj) => (
          <div 
            key={proj.projeto_id} 
            onClick={() => navigate(`/estampos/${proj.estampo_id}/pecas`)}
